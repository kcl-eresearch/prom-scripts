...
parser.add_argument("--ssh_key", default=os.environ.get("SSH_KEY"), help="Path to the SSH private key for authentication")
...
parser.add_argument("--threads", type=int, default=os.environ.get("MAX_TRANSFERS", 5), help="Number of threads to use for copying files")
